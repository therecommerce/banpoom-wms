    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12">
                <h3 class="content-header-title mb-50">셀러회원 관리</h3>
            </div>
        </div>
        <hr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var columnFields = ["checkbox", "account_no", "account_id", "account_name", "business_info_flag", "account_dormant", "vip_grade", "last_login", "reg_dt", "", "start_dt", "end_dt"];
        var columWidths = [ 30, 80, 80, 80, 80, 80, 80, 80, 80, 30, 0, 0];

        init_datatable("${pageContext.request.contextPath}/sellerManagement.json", columnFields, columWidths, fn_tbl_render);
    });
    ...
    function fn_tbl_render(data, type, full, meta) {
        ...
        if (meta.col == 0) {
            ...
            if (full.business_info_flag == 0) {
                return '사업자 미인증';
            } else if (full.business_info_flag == 1) {
                return '사업자 승인대기';
            } else {
                return '사업자 인증';
            }
        ...
        if (meta.col == 7) {
            if (full.last_login == '' || full.last_login == null) {
                return '-';
            } else {
        ...
        if (meta.col == 9) {
            return `<button type="text" class="btn btn-sm btn-outline-blue" onclick="location.href='sellerManagementEdit.do?account_id=` + full.account_id + `'">상세보기</button>`;
        } else {
            if(data != null) {
                return data;
            } else{
