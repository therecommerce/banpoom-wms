...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <h3 class="content-header-title mb-2">쿠폰 수정</h3>
        </div>
        <hr>
        <div class="content-body">
                            ...
                            <div class="card-body">
                                <div class="card-text">
                                                ...
                                                <dd class="col-sm-10">
                                                    <div class="form-group row col-md-4 border-bottom-0">
                                                        ...
                                                        <select id="selectCouponType" name="interested" class="form-control border-blue-grey" onchange="changeTypeForm()">
                                                            <option value="주문금액 적용 쿠폰" <c:if test="${couponVO.coupon_type== '주문금액 적용 쿠폰'}">selected=""</c:if> >주문 적용 쿠폰</option>
                                                            <option value="배송비 적용 쿠폰" <c:if test="${couponVO.coupon_type== '배송비 적용 쿠폰'}">selected=""</c:if>>배송료 적용 쿠폰</option>
                                                        </select>
                                                    </div>
                                                </dd>
                                            </dl>
                                                ...
                                                <dd class="row col-sm-10">
                                                    <div class="form-group col-md-4 border-bottom-0">
                                                        ...
                                                        <select id="selectGivingType" name="interested"
                                                            ...
                                                            <option value="다운로드" <c:if test="${couponVO.coupon_classification == '다운로드'}">selected=""</c:if>>다운로드</option>
                                                            <option value="자동 지급" <c:if test="${couponVO.coupon_classification == '자동 지급'}">selected=""</c:if>>자동 지급</option>
                                                            <option value="쿠폰 코드" <c:if test="${couponVO.coupon_classification == '쿠폰 코드'}">selected=""</c:if>>쿠폰 코드</option>
                                                        </select>
                                                    </div>
                                                    <div id="couponCode" class="form-group col-md-3 border-bottom-0" <c:if test="${couponVO.coupon_classification != '쿠폰 코드'}">style="display: none"</c:if>>
                                                        <input type="text" id="coupon_code" class="form-control" value="${couponVO.coupon_code}">
                                                    </div>
                                                </dd>
                                            </dl>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <dl class="row">
                                                ...
                                                <dd class="col-sm-10">
                                                    <div class="form-group row col-md-4 border-bottom-0">
                                                    <input type="text" id="coupon_name" class="form-control border-blue-grey" value="${couponVO.coupon_name}">
                                                    </div>
                                                </dd>
                                            </dl>
                                        </div>
                                                    ...
                                                    <div class="form-group col-md-12 border-bottom-0">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio20" id="radio1" value="전체 카테고리" <c:if test="${couponVO.coupon_category == '전체 카테고리'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                                                <label class="custom-control-label" for="radio1">전체 카테고리</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" name="colorRadio20" id="radio2" value="카테고리 선택" <c:if test="${couponVO.coupon_category == '카테고리 선택'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                                                <label class="custom-control-label" for="radio2">카테고리 선택</label>
                                                            </div>
                                                            <div class="row col-md-6">
                                                                <div class="form-group border-bottom-0">
                                                                    <select id="topName" class="search_tag form-control-sm border-blue-grey width-100" name="14" onchange="changeMiddle();">
                                                                ...
                                                                <div class="form-group border-bottom-0">
                                                                    <select id="middle" class="search_tag form-control-sm border-blue-grey width-100" name="13">
                                                                        <option selected value="">전체</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" name="colorRadio20" id="radio3" value="만원샵" <c:if test="${couponVO.coupon_category == '만원샵'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                            ...
                                            <dl class="row">
                                                ...
                                                <dd class="col-sm-10">
                                                    <div class="form-group col-md-12 border-bottom-0" id="disCountOrder">
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio1" id="radio14" value="정률 할인" <c:if test="${couponVO.sale_type == '정률 할인'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                                            ...
                                                            <div class="row col-md-6">
                                                                <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="sale_percent" class="form-control-sm border-grey-blue col-md-1"
                                                                       placeholder="" name="" value="${couponVO.sale_percent}">%, 최대
                                                                <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="sale_limit" class="form-control-sm border-blue-grey col-md-1"
                                                                       placeholder="" name="" value="${couponVO.sale_limit}">원 까지 할인
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio1" id="radio15" value="정액 할인" <c:if test="${couponVO.sale_type == '정액 할인'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                                            ...
                                                            <div class="row col-md-6">
                                                                <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="sale_price" class="form-control-sm border-blue-grey col-md-1"
                                                                       placeholder="" name="" value="${couponVO.sale_price}"disabled>원 할인
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-12 border-bottom-0" id="disCountShipping" style="display: none">
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio11"
                                                                       id="radio4" onclick="" <c:if test="${couponVO.sale_type == '배송비 무료'}">checked="true"</c:if> value="배송비 무료" onchange="checkBoxChange(this)">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio11"
                                                                       id="radio5" value="배송비에서 정액 할인"  <c:if test="${couponVO.sale_type == '배송비에서 정액 할인'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                            ...
                                            <dl class="row">
                                                ...
                                                <dd class="col-sm-10">
                                                    <div class="form-group col-md-12 border-bottom-0">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio2" id="radio6" value="제한없음" <c:if test="${couponVO.minimum_type == '제한없음'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                                                <label class="custom-control-label" for="radio6">제한없음</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio2" id="radio7" value="제한있음" <c:if test="${couponVO.minimum_type == '제한있음'}">checked="true"</c:if>  onchange="checkBoxChange(this)">
                                                                <label class="custom-control-label" for="radio7">
                                                                    <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="minimum_price" class="form-control-sm border-blue-grey" value="${couponVO.minimum_price}" disabled>
                                                                </label>
                                                            </div>
                                                            <div class="row col-md-6">
                                                                &nbsp;이상 구매시 사용 가능
                                            ...
                                            <dl class="row">
                                                ...
                                                <dd class="col-sm-10 content-left">
                                                    <div class="form-group col-md-12 border-bottom-0">
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio3" id="radio8" value="복수 발급 불가" <c:if test="${couponVO.duplicate_type == '복수 발급 불가'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                                                <label class="custom-control-label" for="radio8">복수 발급 불가</label>
                                                            </div>
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio3" id="radio9" value="복수 발급 가능" <c:if test="${couponVO.duplicate_type == '복수 발급 가능'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                                                <label class="custom-control-label" for="radio9">
                                                                    복수 발급 가능
                                                                </label>
                                                            </div>
                                                            <div class="row col-md-4">
                                                                <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="issuance_count" class="form-control-sm border-blue-grey col-md-2" value="${couponVO.issuance_count}" disabled>개 까지 발급 가능
                                                            </div>
                                                        </div>
                                                    </div>
                                                </dd>
                                            ...
                                            <dl class="row">
                                                ...
                                                <dd class="col-sm-10">
                                                    <div class="form-group col-md-12 border-bottom-0">
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio4" id="radio10" value="중복 사용 불가" <c:if test="${couponVO.overlap_use == '중복 사용 불가'}">checked="true"</c:if>>
                                                                <label class="custom-control-label" for="radio10">중복 사용 불가</label>
                                                            </div>
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio4" id="radio11" value="중복 사용 가능" <c:if test="${couponVO.overlap_use == '중복 사용 가능'}">checked="true"</c:if>>
                                            ...
                                            <dl class="row">
                                                ...
                                                <dd class="col-sm-10">
                                                    <div class="form-group col-md-12 border-bottom-0">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio5" id="radio12" value="발급일로부터" <c:if test="${couponVO.reg_dt_type == '발급일로부터'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                                                <label class="custom-control-label" for="radio12">발급일로부터</label>
                                                            </div>
                                                            <div class="row col-md-6">
                                                                <input type="text" id="day" class="form-control-sm border-blue-grey col-md-1" value="${couponVO.diffDate}">일
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input" name="colorRadio5" id="radio13" value="기간 직접 선택" <c:if test="${couponVO.reg_dt_type == '기간 직접 선택'}">checked="true"</c:if> onchange="checkBoxChange(this)">
                                                            ...
                                                            <div class="d-flex justify-content-start align-items-start p-0">
                                                                <div class="d-flex align-items-center justify-content-start">
                                                                    <div class="input-group">
                                                                        <input type='text' id="start_dt" name="9" class="search_tag form-control pickadate-selectors" placeholder="" value="${couponVO.start_dt}" disabled/>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type='text' id="end_dt" name="10"
                                                                               ...
                                                                               placeholder="" value="${couponVO.end_dt}" disabled/>
                                                                        <div class="input-group-append">
                                                                            <span class="input-group-text">
                                                                                <span class="fa fa-calendar-o"></span>
                                                                            </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <dl class="row">
                                                <dt class="col-sm-2">쿠표 표시 이미지<span
                                                        class="danger">*</span></dt>
                                                <dd class="col-sm-10">
                                                    <div class="form-group col-md-12 border-bottom-0">
            ...
            <div class="col-md-12">
                ...
                <button type="button" class="btn btn-light btn-min-width mr-1">취소</button>
                    <button type="submit" class="btn btn-blue btn-min-width" onclick="updateCoupon();">저장</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <script type="text/javascript">
                let percent = 0;
                 ...
                 $(document).ready(function () {
                     if(${couponVO.coupon_category == '카테고리 선택'}){
                         $('#topName').val(${couponVO.coupon_parent_category_id});
                         ...
                         $.ajax({
                             ...
                             success : function(result) {
                                 ...
                                 $('#middle').val(${couponVO.coupon_category_id});
                             }
                         });
                     }
                     var grade = '${couponVO.issuance_grade}';
                     var gradeList = grade.split(',');

                     $("input[name=selectAll1]").each(function() {
                         for(var i = 0; i< gradeList.length ; i++){
                             if($(this).val() == gradeList[i]) {
                                 $(this).prop("checked", true);
                             }
                         }
                     });

                     $('#coupon_memo').val('${couponVO.coupon_memo}');
                     changeTypeForm();
                     changeGivingForm();
                     changeForm('${couponVO.coupon_category}');
                     changeForm('${couponVO.sale_type}');
                     changeForm('${couponVO.reg_dt_type}');
                     changeForm('${couponVO.minimum_type}');
                     changeForm('${couponVO.duplicate_type}');
                 ...
                 function updateCoupon() {
                     ...
                     $.ajax({
                         url : "${pageContext.request.contextPath}/promotion/updateCoupon.json",
                         type : "POST",
                         data: params,
                         success : function(result) {
