    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12">
                <h3 class="content-header-title mb-50">상품문의(네이버)</h3>
            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row" style="height: 74px">
                                        ...
                                        <div class="col-md-5 border-left-0">
                                            ...
                                            <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                <input type="checkbox" class="custom-control-input" name="selectOne1" id="checkSearch1" value="0">
                                                <label class="custom-control-label" for="checkSearch1">미답변</label>
                                            </div>
                                            <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                <input type="checkbox" class="custom-control-input" name="selectOne1" id="checkSearch2" value="1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex justify-content-start align-items-start">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-start">
                                                            <div class="input-group">
                                                                <input type='text' id="end_dt" name="8"
                                                                       class="search_tag form-control pickadate-selectors"
                                                                       placeholder="" value="" />
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text">
...
<script>
    $(document).ready(function() {
        let columnFields = [ "questionId", "product_id", "question", "answered", "maskedWriterId", "createDate", "product_name", "start_dt", "end_dt"];
        let columWidths = [ 15, 20, 20, 30, 10, 10, 10, 0, 0];

        init_datatable("${pageContext.request.contextPath}/customer/naverQna.json", columnFields, columWidths, fn_tbl_render);
        // fn_search();
    ...
    function fn_tbl_render(data, type, full, meta) {
        ...
        if (meta.col == 0) {
            ...
            } else if (full.answered == 1) {
                return '<span class="badge bg-light-blue width-100" style="color: blue">답변완료</span>';
            }
        } else if (meta.col == 4) {
            return full.maskedWriterId;
        } else if (meta.col == 5) {
            return full.createDate;
        } else if (meta.col == 6) {
            if (full.answered == 0) {
                return `<button type="button" class="btn btn-sm btn-outline-grey-blue" onclick="location.href='naverQnaManagementDetail.do?questionId=`+full.questionId+`'"> 답변등록 </button>`;
            } else if (full.answered == 1) {
                return `<button type="button" class="btn btn-sm btn-outline-bitbucket" onclick="location.href='naverQnaManagementDetail.do?questionId=`+full.questionId+`'"> 답변보기 </button>`;
            }
        }
    ...
    function fn_search() {
        ...
        if(search == null) {
            search = table.column(3).search(statusArray);
        } else {
            search = search.column(3).search(statusArray);
        }
        ...
        if(search == null) {
            ...
            search = search.column(8).search(end_dt);
        } else {
