  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12">
        <h3 class="content-header-title mb-50">1:1 문의(셀러)</h3>
      </div>
                ...
                <div class="col-9">
                  <div class="form-group row last">
                    <div class="col-md-11 border-left-0">
                      <div class="row">
                        <label class="col-md-1 label-control text-left" for="searchInput">조회기간</label>
...
<script>
  $(document).ready(function() {
    let columnFields = [ "qna_no", "qna_type2", "qna_title", "qna_state", "account_id", "qna_reg_dt", "button", "start_dt", "end_dt"];
    let columWidths = [ 30, 30, 30, 30, 30, 30, 30, 0, 0];

    init_datatable("${pageContext.request.contextPath}/customer/sellerInquiry.json", columnFields, columWidths, fn_tbl_render);
    fn_search();
  ...
  function fn_tbl_render(data, type, full, meta) {
    if(meta.col == 3) {
      ...
      if (full.qna_state == '미답변') {
        return `<button type="button" class="btn btn-sm btn-outline-grey-blue" onclick="location.href='manOnManQnaSellerDetail.do?qna_no=`+full.qna_no+`'"> 답변등록 </button>`;
      } else if (full.qna_state == '답변완료') {
        return `<button type="button" class="btn btn-sm btn-outline-grey-blue" onclick="location.href='manOnManQnaSellerDetail.do?qna_no=`+full.qna_no+`'"> 답변보기 </button>`;
      }
    }
    return data;
  }   // 초기 렌더
