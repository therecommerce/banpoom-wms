    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12">
                <h3 class="content-header-title mb-50">출고 관리</h3>
            </div>
        </div>
        <hr>
                            ...
                            <div class="row">
                                <div class="col-md-6 border-right-blue-grey border-right-lighten-5">
                               	...
                               	<div class="col-md-6 border-right-blue-grey border-right-lighten-5">
                                    <div class="form-group row">
                                        <label class="col-md-2 label-control text-left"
                                               for="searchState">출고상태</label>
                                        <div class="col-md-10 border-left-0">
                                            <div class="row">
                                                <div class="form-group col-md-4 border-bottom-0">
                                                    <label class="sr-only" for="searchValue">전체</label>
                                                    <select id="searchState" name="2" class="search_tag form-control">
                                                        <option value="" selected="">전체</option>
                                                        <option value="N">출고대기</option>
                                                        <option value="F">출고완료</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        let columnFields = ["reg_dt", "type", "state","seller_name", "smartstore_name", "product_id", "product_name", "product_count", "start_dt", "end_dt"];
        let columWidths = [80, 80, 80, 80, 80, 80, 80, 80, 0, 0];

        init_datatable("${pageContext.request.contextPath}/inventory/outboundshippingList.json", columnFields, columWidths, fn_tbl_render);
    });
