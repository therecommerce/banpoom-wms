            ...
            <section>
                <div class="form-group row">
                    <div class="col-md-5 border-left-0">
                        <div>
                            <a href="${pageContext.request.contextPath}/consignCalculate.do"><button type="button" class="btn btn-outline-light"><</button>
                            </a>&nbsp;&nbsp;&nbsp;&nbsp;<span class="font-medium-4">정산 상세 내역</span>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-md-12">
                                    <div>
                                        <span class="font-medium-4">
                                            <c:if test="${calculateVO.cal_state == '정산예정'}">
                                                <button disabled class="btn btn-sm btn-outline-purple"> 정산예정</button>
                                            </c:if>
                                            <c:if test="${calculateVO.cal_state == '정산완료'}">
                                                <button disabled class="btn btn-sm btn-outline-blue"> 정산완료</button>
                                            </c:if>
                                            ${calculateVO.cal_id}
                                        </span>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xl-2 col-lg-6 col-6 border-right-blue-grey border-right-lighten-5">
                                            <div class="card">
                                        ...
                                        <div class="col-xl-2 col-lg-6 col-6">
                                            <div class="card">
                                                <div class="card-content">
                                                    <div class="card-body height-80">
                                                        <p class="sub-heading">정산 셀러수</p>
                                                        <span class="h5 heading-text text-bold-600"><fmt:formatNumber type="number" value="${calculateVO.seller_count}"/>명</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-lg-6 col-6">
                                            <div class="card">
                                                <div class="card-content">
                                                    <div class="card-body height-80">
                                                        <p class="sub-heading">총 판매금액</p>
                                                        <span class="h5 heading-text text-bold-600"><fmt:formatNumber type="number" value="${calculateVO.product_vprice}"/>원</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-lg-6 col-6">
                                            <div class="card">
                                                <div class="card-content">
                                                    <div class="card-body height-80">
                                                        <p class="sub-heading">판매수수료</p>
                                                        <span class="h5 heading-text text-bold-600"><fmt:formatNumber type="number" value="${calculateVO.sell_commission}"/>원</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <button type="button" class="btn btn-outline-blue btn-min-width mr-1" data-toggle="modal" data-target="#modal-1">입금확인</button>
                    </div>
                    <div class="col-md-2 ml-auto row">
                        <select id="searchProduct" name="3" class="search_tag form-control">
                            <option value="" selected="">전체</option>
                            <option value="0">정산예정</option>
                            <option value="1">정산완료</option>
                        </select>
                    </div>
                    <div class="col-md-2">
                            <div class="form-group position-relative">
                                <input type="search" class="search_tag form-control" id="searchValue" name="2" placeholder="셀러이름을 입력하세요.">
            ...
            <section>
                <div class="users-list-table">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <button class="nav-link btn btn-sm btn-outline-blue float-right" type="button" onclick="exportExcel('outer');">다운로드</button>
                                <!-- datatable start -->
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-blue-grey bg-lighten-5">
                <h4 class="modal-title" id="myModalLabel20">정산확인</h4>
            ...
            <div class="modal-footer justify-content-center">
                ...
                <button type="submit" class="btn btn-blue btn-min-width" data-dismiss="modal" onclick="updateCalculateState('정산예정')">확인</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade text-left" id="calculateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div>
                <input id="modalCalNo" type="hidden" value="">
                <button id="calBtn" class="nav-link btn btn-sm btn-outline-blue float-right" type="button" onclick="updateCalStateModal();" style="margin-right: 30px;"  >정산하기</button>
                <button id="emailSendBtn" class="nav-link btn btn-sm btn-outline-blue float-right disabled" type="button" style="margin-right: 10px;"  >이메일보내기</button>
                <button id="downloadBtn" class="nav-link btn btn-sm btn-outline-blue float-right" type="button" onclick="exportExcel('inner');" style="margin-right: 10px;"  >다운로드</button>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item border-0 p-50 d-flex justify-content-between">
                            <div class="cost-title mr-auto">
                                ...
                                <span class="font-medium-4"><button id="cal_state" disabled class="btn btn-sm btn-outline-blue"> 정산예정</button> <span id="cal_id"></span></span>
                                <hr style="">
                                <p class="mb-0">
                        ...
                        <div class="modal-body">
                            ...
                            <h4 class="card-title bg-blue bg-lighten-5 border-top p-1 mb-1">
                                일반 정산 요약
                                <span id="normalCalculateTotal" class="float-right">1</span>
                                <span id="normalCalculateCommission" class="float-right">2</span>
                                <span id="normalCalculatePrice" class="float-right">3</span>
                                <div></div>
                            </h4>
...
<%--        <script src="cdn.datatables.net/1.13.1/css/jquery.dataTables.min.css"></script>--%>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                let columnFields = ["checkbox", "cal_id", "account_name", "cal_state", "cal_no", "product_vprice", "sell_commission", "cal_price_total", ""];
                let columWidths = [10, 20, 20, 20, 20, 20, 20, 20, 10];


                init_datatable1("${pageContext.request.contextPath}/calculateDetail.json", columnFields, columWidths, fn_tbl_render, ${cal_month_no}, 10);
            ...
            function fn_tbl_render(data, type, full, meta) {
                ...
                if (meta.col == 4) {
                    return full.cal_no + "개";
                }
                if (meta.col ==5) {
                    return full.product_vprice.toLocaleString('ko-KR') + "원";
                }
                if (meta.col == 6) {
                ...
                if (meta.col == 8) {
                    return `<button type="text" class="btn btn-sm btn-outline-blue" data-toggle="modal" data-target="#calculateModal" onclick="selectModal('`+ full.cal_id + `')">정산확인서</button>`;
                }
                return data;
            }
            ...
            function selectModal(cal_no) {

                let columnFields1 = ["sell_type", "order_request_id", "product_id", "product_name", "order_product_count" , "consumer", "product_price", "sell_commission", "cal_price", "order_request_dt", "order_decide_dt"];
                let columWidths1 = [30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30];
                init_datatable2("${pageContext.request.contextPath}/selectCalculateModalTableDetail.json", columnFields1, columWidths1, fn_tbl_render2, cal_no, 10);
                ...
                $.ajax({
                    ...
                    success : function(result) {
                        if (result.resultCode === "success") {
                            $('#cal_state').text(result.data.cal_sate);
                            if(result.data.cal_state == '정산예정'){
                                $('#cal_state').attr('class','btn btn-sm btn-outline-purple')
                                $('#calBtn').css('margin-right','30px');
                                $('#emailSendBtn').css('margin-right','10px');
                            }else {
                                $('#cal_state').attr('class','btn btn-sm btn-outline-blue')
                                $('#calBtn').css('display','none');
                                $('#emailSendBtn').css('margin-right','30px');
                            }
                            $('#cal_state').text(result.data.cal_state);
                            $('#cal_id').text(result.data.cal_id);
                            $('#thisMonthCalculateTotal').text(result.data.cal_price.toLocaleString('ko-KR') + "원");
                            $('#sellerName').text("셀러명 : " + result.data.account_name + "   ");
                            $('#bankAccount').text("입금계좌 : " + result.data.bank_name + " " + result.data.account_num + " (" + result.data.depositor + ")   ");
            ...
            function fn_tbl_render2(data, type, full, meta) {
                ...
                if (meta.col == 6) {
                    return full.product_price.toLocaleString('ko-KR') + "원";
                }
                if (meta.col == 7) {
                    return full.sell_commission.toLocaleString('ko-KR') + "원";
                }
                if (meta.col == 8) {
                    return full.cal_price.toLocaleString('ko-KR') + "원";
                }
                if (meta.col == 9) {
            ...
            function updateCalStateModal() {
                var cal_no = $('#modalCalNo').val();
                let chk_val = [];
                let isShowEmpty = true;
                chk_val.push(cal_no);
            ...
            function exportExcel(type){
                ...
                // 시트 생성
                var newWorksheet = excelHandler.getWorksheet(type);
                // 생성된 워크시트에 이름 만들기
                XLSX.utils.book_append_sheet(wb, newWorksheet, excelHandler.getSheetName(type));
                // 엑셀파일 생성
                var wbout = XLSX.write(wb, {bookType:'xlsx',  type: 'binary'});
                // 엑셀파일 내보내기
                saveAs(new Blob([stringToUint8ArrayBuffer(wbout)],{type:"application/octet-stream"}), excelHandler.getExcelFileName(type));
            }

            var excelHandler = {
                getExcelFileName : function(type){
                    return type == 'outer' ? '정산 상세 내역.xlsx' : '정산 상세 내역(상품).xlsx';  // 파일명
                },
                getSheetName : function(type){
                    return type == 'outer' ? '정산 상세' : '정산 상세(상품)';  // 파일명
                },
                getExcelData : function(type){
                    // return document.getElementById('user_data_table'); // 테이블 id

                    var table = document.getElementById(type =='outer'? 'user_data_table': 'calDetail');
                    var clonedTable = table.cloneNode(true);
                    var rows = clonedTable.getElementsByTagName('tr');
                    var headerRow = rows[0];
                    if(type =='outer'){
                        var headerCells = headerRow.getElementsByTagName('th');
                        var firstHeaderCell = headerCells[0];
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        if(type =='outer'){
                            if (cells.length > 8) {
                                ...
                                rows[i].removeChild(cells[0]); // 첫 번째 열 삭제
                            }
                        }
                    }
                ...
                getWorksheet : function(type){
                    return XLSX.utils.table_to_sheet(this.getExcelData(type));
