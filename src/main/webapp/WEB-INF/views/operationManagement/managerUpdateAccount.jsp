  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12">
        <h3 class="content-header-title mb-50">개인 정보</h3>
      </div>
    </div>
    <hr>
              ...
              <div class="row">
                  ...
                  <div class="col-md-9 border-left-0">
                    <div class="row">
                      <div class="form-group col-md-12 border-bottom-0">
                        <input type="text" id="account_name" name="interested" class="form-control" value="${managerVO.account_name}">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-9 border-left-0">
                    <div class="row">
                      <div class="form-group col-md-12 border-bottom-0">
                        <input id="account_email" name="interested" class="form-control" value="${managerVO.account_email}">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  ...
                  <div class="col-md-9 border-left-0">
                    <div class="row">
                      <div class="form-group col-md-12 border-bottom-0">
                        <input id="account_tel" name="interested" class="form-control" maxlength="13" oninput="autoHyphen(this);" value="${managerVO.account_tel}">
                      </div>
                    </div>
                  </div>
                </div>
...
<script type="text/javascript">
  ...
  function managerUpdate() {
    ...
    if (params.account_pwd != document.getElementById("account_pwd2").value) {
      alert("비밀번호 확인해 주세요");
    } else {
      $.ajax({
        url : "${pageContext.request.contextPath}/operation/updateManagerAccount.json",
        type : "POST",
