  ...
  <div class="content-wrapper">
    ...
    <div class="content-body">
              ...
              <div class="row">
                  ...
                  <div class="col-md-9 border-left-0">
                    <div class="row">
                      <div class="form-group col-md-12 border-bottom-0">
                        <input type="text" id="account_name" name="interested" class="form-control">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  ...
                  <div class="col-md-9 border-left-0">
                    <div class="row">
                      <div class="form-group col-md-12 border-bottom-0">
                        <input id="account_id" name="interested" class="form-control">
                      </div>
                    </div>
                  </div>
                </div>
                  <div class="col-md-3">
                    ...
                    <div class="col-md-9 border-left-0">
                      <div class="row">
                        <div class="form-group col-md-12 border-bottom-0">
                          <input type="password" id="account_pwd" name="interested" class="form-control">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    ...
                    <div class="col-md-9 border-left-0">
                      <div class="row">
                        <div class="form-group col-md-12 border-bottom-0">
                          <input type="password" id="account_pwd2" name="interested" class="form-control">
                        </div>
                      </div>
                    </div>
                  </div>
                <div class="col-md-3">
                  ...
                  <div class="col-md-9 border-left-0">
                    <div class="row">
                      <div class="form-group col-md-12 border-bottom-0">
                        <input id="account_email" name="interested" class="form-control">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  ...
                  <div class="col-md-9 border-left-0">
                    <div class="row">
                      <div class="form-group col-md-12 border-bottom-0">
                        <input id="account_tel" name="interested" class="form-control" maxlength="13" oninput="autoHyphen(this);">
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="col-md-12">
        ...
        <button type="submit" class="btn btn-outline-blue btn-min-width" onclick="managerRegister()">저장</button>
      </div>
    </div>
    <!-- END: Content-->
...
<script type="text/javascript">
  ...
  function managerRegister() {
    let params = {
      ...
      "account_pwd" : document.getElementById('account_pwd').value,
    ...
    $.ajax({
      url : "${pageContext.request.contextPath}/operation/managerRegister.json",
      type : "POST",
