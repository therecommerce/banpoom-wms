    ...
    <div class="content-wrapper">
                                ...
                                <div class="col-md-12 border-right-blue-grey border-right-lighten-5">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5 border-left-0" id="checkbox">
                                            ...
                                            <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                <input type="checkbox" class="custom-control-input"
                                                       name="selectOne1" id="checkSearch1" value="반품 요청">
                                                <label class="custom-control-label" for="checkSearch1">반품 요청</label>
                                            </div>
                                            <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                <input type="checkbox" class="custom-control-input"
                                                       name="selectOne1" id="checkSearch2" value="반품 거절">
                                                <label class="custom-control-label" for="checkSearch2">반품 거절</label>
                                            </div>
                                            <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                <input type="checkbox" class="custom-control-input"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <button type="button" class="btn btn-outline-blue btn-min-width mr-1"
                                            data-toggle="modal" data-target="#modal-2">반품 거절</button>
                                    <button type="button" class="btn btn-outline-blue btn-min-width mr-1"
                                            data-toggle="modal" data-target="#modal-3">반품 거절철회</button>
        ...
        <div class="modal fade text-left" id="modal-2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel20"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-blue-grey bg-lighten-5">
                        <h4 class="modal-title" id="myModalLabel20">반품 거절</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <div class="modal fade text-left" id="modal-3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel20"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-blue-grey bg-lighten-5">
                        <h4 class="modal-title" id="myModalLabel20">반품 거절철회</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body text-center">
                        <h5 class="my-4">반품 거절건을 철회하시겠습니까?</h5>
                    </div>
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-light btn-min-width" data-dismiss="modal">취소</button>
                        <button type="submit" class="btn btn-blue btn-min-width" data-dismiss="modal" onclick="javascript:changeStatus('반품 거절 철회');">확인</button>
                    </div>
                </div>
            </div>
        </div>
...
<jsp:include page="/WEB-INF/views/common/sideBar.jsp" flush="false" />
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                init_datatable("${pageContext.request.contextPath}/direct/returnManagement.json", columnFields, columWidths, fn_tbl_render);
            });
            ...
            function changeStatus(state) {
                ...
                var params = {
                    ...
                    // 'return_request_id': document.getElementById('return_request_id').value
                }
