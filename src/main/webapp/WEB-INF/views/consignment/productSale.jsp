    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12">
                <h3 class="content-header-title mb-50">상품/판매 목록</h3>
            </div>
        </div>
        <hr>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body height-80">
                                    ...
                                    <a href="#" onclick="searchStatus('판매중');"><span class="h5 heading-text text-bold-600" style="font-size: 30px">${productCountVO.sellingCount}</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body height-80">
                                    ...
                                    <a href="#" onclick="searchStatus('판매중지');"><span class="h5 heading-text text-bold-600" style="font-size: 30px">${productCountVO.stopCount}</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body height-80">
                                    ...
                                    <a href="#" onclick="searchStatus('품절');"><span class="h5 heading-text text-bold-600" style="font-size: 30px">${productCountVO.soldOutCount}</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="form form-horizontal form-bordered">
                        <div class="form-body">
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 border-left-0">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 border-bottom-0">
                                                    <select id="middle" name="13" class="search_tag form-control">
                                                        <option selected value="">전체</option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-8 border-right-blue-grey border-right-lighten-5">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <hr class="my-2">
                            <!-- datatable started -->
                            <div id="app-invoice-wrapper" class="" style="overflow: auto;">
...
<jsp:include page="/WEB-INF/views/common/sideBar.jsp" flush="false" />
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var columnFields = ["checkbox", "product_id", "sell_type", "seller_name", "category_name", "product_name", "product_vprice", "product_count", "product_state", "product_selling_dt", "modify", "start_dt", "end_dt", "category_id", "parent_category_id"];
                var columWidths = [ 30, 80, 80, 80, 80, 80, 80, 80, 80, 80, 30, 0, 0 ,0, 0];

                init_datatable("${pageContext.request.contextPath}/consignment/sellingList.json", columnFields, columWidths, fn_tbl_render);
            });
            ...
            function fn_tbl_render(data, type, full, meta) {
                ...
                if (meta.col == 0) {
                    ...
                    return `<button type="text" class="btn btn-sm btn-outline-blue" onclick="location.href='consignmentDetail.do?product_id=` + full.product_id + `&isSelling=true'">상세보기</button>`;
                } else {
                    if(data != null) {
                        return data;
                    } else{
            ...
            function fn_search() {
                ...
                if(search == null) {
                    search = table.column(11).search(start_dt);
                    search = search.column(12).search(end_dt);
                }else {
                    search = search.column(11).search(start_dt);
                    search = search.column(12).search(end_dt);
                }
